...
| `starting_before_or_at_height`    | query     | [Height]          | The timestamp filter for rewards starting before or at.       |
| `starting_before_or_at`           | query     | [DateTime in utc] | The block height filter for rewards starting before or at.    |
:::
