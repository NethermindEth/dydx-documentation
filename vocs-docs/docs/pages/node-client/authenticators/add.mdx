...
| ----------------- | --------- | ----------------- | ----------------------------------------------------------------------------- |
| `wallet`          | query     | [Wallet]          | The wallet to use for signing the transaction or authenticating the request.  |
| `authenticator`   | query     | [Authenticator]   | The authenticator to be added.                                                |
